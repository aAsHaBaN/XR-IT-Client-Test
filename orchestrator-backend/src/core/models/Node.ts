...
// In XR-IT a machine connected to the network is designated as a Node.
...
export type XRITNodeRole = "orchestrator" | "node";
...
export class Node implements INode {
  ...
  // Sends a message to the Node over the socket that is registered with this node. 
  // If the node is not currently connected (no socket connected) an error is thrown.
  ...
  // Returns a software configuration registered with this node with matching id.
