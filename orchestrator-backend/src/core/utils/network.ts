...
// Helper function for getting the IP of the machine running the application
...
/*
  ...
  this function searches for the lowest IP address that is not already in a list of IPs.
*/
